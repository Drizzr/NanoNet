...
from NanoNet.optimizer import SGD, SGD_Momentum, RMSPromp
...
net = Network([784, 100, 20, 10], 10, RMSPromp(0.0002),[ReLu(), ReLu(), SoftMax()], LogLikelihood(), test_data=test_data, training_data=training_data, w_init_size="large")
